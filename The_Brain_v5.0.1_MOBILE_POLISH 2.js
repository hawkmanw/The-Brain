// ==UserScript==
// @name         Torn PDA - The Brain V5.0.1 - Mobile Polish
  ...
  */
   ...
   */
    ...
    function buildStrategicSaleControls(owned = latestOwnedShares) {
        if (!owned) {
            return '<div style="color:#888;">Analyze current holdings to identify strategic-benefit stocks.</div>';
        }
...
<div style="font-size:22px;font-weight:bold;color:${color};line-height:1.1;">
    ...
    function setAnalyzeButton(state) {
        ...
        const labels = {
            idle: 'Analyze Current Holdings',
            thinking: 'Reading portfolio...',
    ...
    function renderApiKeyRequired() {
        out(`
            <div style="line-height:1.5;">
                <b>Welcome to The Brain.</b><br><br>
...
`;
    ...
    function injectBrainResponsiveStyles() {
        ...
        style.textContent = `
            /* The Brain v5.0.1 — portrait-mobile presentation only. */
